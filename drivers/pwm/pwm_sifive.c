...
#define PWM_SIFIVE_INIT(n)	\
	...
	static struct pwm_sifive_cfg pwm_sifive_cfg_##n = {	\
		.base = DT_SIFIVE_PWM_##n##_BASE_ADDR,	\
		.f_sys = DT_SIFIVE_PWM_##n##_CLK_FREQ,  \
		.cmpwidth = CONFIG_PWM_SIFIVE_CMPWIDTH,	\
		};	\
	DEVICE_AND_API_INIT(pwm_##n,	\
			DT_SIFIVE_PWM_##n##_LABEL,	\
			pwm_sifive_init,	\
			&pwm_sifive_data_##n,	\
			&pwm_sifive_cfg_##n,	\
			POST_KERNEL,	\
...
#ifdef DT_SIFIVE_PWM_0_LABEL
PWM_SIFIVE_INIT(0);
#endif /* DT_SIFIVE_PWM_0_LABEL */

#ifdef DT_SIFIVE_PWM_1_LABEL
PWM_SIFIVE_INIT(1);
#endif /* DT_SIFIVE_PWM_1_LABEL */

#ifdef DT_SIFIVE_PWM_2_LABEL
PWM_SIFIVE_INIT(2);
#endif /* DT_SIFIVE_PWM_2_LABEL */
