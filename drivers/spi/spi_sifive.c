...
#define SPI_INIT(n)	\
	...
	static struct spi_sifive_cfg spi_sifive_cfg_##n = { \
		.base = DT_SIFIVE_SPI_##n##_BASE_ADDR, \
		.f_sys = DT_SIFIVE_SPI_##n##_CLK_FREQ, \
	}; \
	DEVICE_AND_API_INIT(spi_##n, \
			DT_SIFIVE_SPI_##n##_LABEL, \
			spi_sifive_init, \
			&spi_sifive_data_##n, \
			&spi_sifive_cfg_##n, \
			POST_KERNEL, \
...
#ifdef DT_SIFIVE_SPI_0_LABEL

SPI_INIT(0);

#endif /* DT_SIFIVE_SPI_0_LABEL */
#endif /* !DT_SIFIVE_SPI_0_ROM */

#ifdef DT_SIFIVE_SPI_1_LABEL

SPI_INIT(1);

#endif /* DT_SIFIVE_SPI_1_LABEL */

#ifdef DT_SIFIVE_SPI_2_LABEL

SPI_INIT(2);

#endif /* DT_SIFIVE_SPI_2_LABEL */
